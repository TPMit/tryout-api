            ...
            where: ({id_tryout:id_tryout, jumlah:jumlah})
              ...
              if (found == null) {
                ...
                //generate expired time
                  ...
                  let batas_waktu_xendit = moment().tz("Asia/Jakarta").add(8, 'hours').toISOString();
                  let expiryDateXendit = new Date(new Date().setHours(new Date().getHours() + 8)).toISOString();
                ...
                switch (metode_pembayaran) {
                  ...
                  parameter = {
                    ...
                    'name': 'user tesujian',
                    'expiration_date' : expiryDateXendit
                  ...
                  va.createFixedVA({
                    ...
                    console.log('======= batas =======');
                      ...
                      // create to table bayar, for save on our server
                          Bayar.create({
                              ...
                              payment_type        :'bank_' +chargeResponse.bank_code,
                              id_tryout           :id_tryout,
                              qrcode              :null,
                              deeplink            :null,
                              status_gopay        :null,
                    ...
                    break;
                  case 'bsi':
                  console.log(batas_waktu_xendit);
                  console.log(metode_pembayaran);
                  parameter = {
                    "externalID": codeBayar,
                    "bankCode": "BSI",
                    "expected_amount": jumlah,
                    'name': 'user tesujian',
                    'expiration_date' : batas_waktu_xendit
                    // "id": "598d91b1191029596846047f",
                    // "paymentId": "5f218745736e619164dc8608",
                    // "callbackVirtualAccountId": "598d5f71bf64853820c49a18",
                    // "merchantCode": "26215",
                  ...
                  .then((chargeResponse)=>{
                    const data = {
                      ...
                      transaction_time    : chargeResponse.transaction_time,
                      transaction_status  : chargeResponse.transaction_status,
                      bank                : chargeResponse.payment_type,
                      actions             : chargeResponse.actions !== null ? chargeResponse.actions : null
                    }
                    console.log(chargeResponse);
                    console.log('======= batas =======');
