...
route.get("/", async (req, res) => {
    PondokService.getHafalanJuz(req.query)
  .then(result=>{
    res.json({
      success: true,
      data: result,
...
route.get("/soal", async (req, res) => {
  PondokService.getSoalHafalanJuz(req.query)
.then(result=>{
  res.json({
    success: true,
    data: result,
...
route.post("/", upload.any() ,async (req, res) => {
    PondokService.newHafalanJuz(req.body)
  .then(result=>{
    res.json({
      success: true,
      data: result,
...
route.put("/:id",upload.single('kunciJawaban') , async (req, res) => {
    PondokService.updateHafalanJuz(parseInt(req.params.id),req.body,req.file)
  .then(result=>{
    res.json({
      success: true,
      data: result,
...
route.delete("/:id", async (req, res) => {
    PondokService.deleteHafalanJuz(parseInt(req.params.id))
  .then(result=>{
    res.json({
      success: true,
      data: result,
...
/**
 * Update hafalanJuz
 * @route POST /hafalanJuz/updateJawaban
 * @group hafalanJuz
...
route.post("/updateJawaban", uploadJawaban.single('filename') ,async (req, res) => {
  PondokService.updateJawabanHafalanJuz(req.body,req.file)
.then(result=>{
  res.json({
    success: true,
    data: result,
...
/**
 * Update hafalanJuz
 * @route POST /hafalanJuz/koreksi
 * @group hafalanJuz
 * @param {integer} idJawabanHafalanJuz.formData.required - id
...
route.post("/koreksi",async (req, res) => {
  PondokService.koreksiHafalanJuz(req.body)
.then(result=>{
  res.json({
    success: true,
    data: result,
