...
let TryoutDetailservice = new TryoutDetails();


/**
 * GET TryoutDetails
 * @route GET /tryoutdetails
...
route.get("/", async (req, res) => {
    TryoutDetailservice.getTryoutDetails(req.query)
  .then(result=>{
    res.json({
      success: true,
      data: result,
...
route.get("/", async (req, res) => {
  console.log('test'+req.query);
    TryoutDetailservice.getDetailPondoks(req.query)
  .then(result=>{
    res.json({
      success: true,
      data: result,
